...
class InputForm extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
        ...
        home: new Scaffold(
            appBar: new AppBar(title: new Text('Пример - Форма ввода')),
            body: new InputFormFullWidget()));
  }
}

class InputFormFullWidget extends StatefulWidget {
  @override
...
class InputFormState extends State {
              ...
              children: <Widget>[
                ...
                new CheckboxListTile(
                    ...
                    title: new Text('Я ознакомлен' +
                        ...
                        ' с документом "Согласие на обработку...'),
